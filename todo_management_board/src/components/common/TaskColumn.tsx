...
function TaskColumn({
  ...
  return (
    <div
      className={`${getColor[color]} bg-opacity-40 min-h-[60px] xl:w-[270px] lg:w-[240px] sm:w-[300px] w-[280px] px-4 pt-2 pb-5 max-w-[800px] overflow-y-auto rounded-md transition-all ease-in-out duration-150`}
    >
